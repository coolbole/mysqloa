...
public class MySQLMonitorHostCUDAction  extends HttpServlet {
	
	private static final long serialVersionUID = 2551449111136325075L;
	private static Log logger = LogFactory.getLog(MySQLMonitorHostCUDAction.class);
	private static ReadMySQLConfigXMLFile  DescriptionXMLFile= new ReadMySQLConfigXMLFile();
	
	public MySQLMonitorHostCUDAction() {super();	}
